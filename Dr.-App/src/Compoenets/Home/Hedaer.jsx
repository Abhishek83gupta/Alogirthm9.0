...
function Header() {
  return (
    <>
      <div className="bg-[#1a2332] mx-4 md:mx-10 flex flex-col md:flex-row justify-between items-center flex-wrap rounded-lg border border-gray-700">
        <div className="mx-4 md:mx-8 gap-6 md:gap-10 py-10 text-center md:text-left">
          ...
          <a
            href="#specification"
            className="rounded-full bg-[#3b82f6] text-white flex flex-row justify-center items-center mt-6 md:mt-10 p-4 md:p-6 w-[200px] md:w-[250px] gap-2 text-sm md:text-lg font-medium hover:-translate-y-2 hover:bg-[#1e3a8a] transition-all duration-500"
          >
